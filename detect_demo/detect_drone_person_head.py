...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        ...
                        # default='weights/fold_v4/fold4.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'C:\Desktop\Py\Drone\Source\yolo\videos\2022-12-14_13-28_myongji_60_10_sunny_afternoon.mp4', help='0 for webcam')
