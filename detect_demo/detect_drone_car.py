            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        if 0.15 > xywh[2] > 0.025 and 0.27 > xywh[3] > 0.045:
                            line = (cls, *xywh, conf) if save_conf else (3, *xywh)  # label format
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='weights/vehicle.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'C:\Desktop\Py\Drone\Source\yolo\videos\2022-12-20_15-27_myongji_45_20_sunny_afternoon.mp4', help='0 for webcam')
