            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        if cls == 0 and 0.15 > xywh[:, 2] > 0.05 and 0.23 > xywh[:, 3] > 0.1:
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=r'C:\Desktop\Py\Drone\Source\yolo\videos\2022-12-19_11-59_myongji_60_10_sunny_morning.mp4', help='0 for webcam')
