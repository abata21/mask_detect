...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            txt_path = str(save_dir / 'labels') + ('' if dataset.mode == 'image' else f'/frame_{str(frame - 1).zfill(6)}')  # im.txt
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        if cls == 0 and 0.065 > xywh[2] > 0.015 and 0.15 > xywh[3] > 0.05:
                            line = (cls, *xywh, conf) if save_conf else (2, *xywh)  # label format
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='weights/crowdhuman.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'C:\Desktop\Py\Drone\Source\yolo\videos\2022-12-19_11-18_myongji_45_20_sunny_morning.mp4', help='0 for webcam')
