...
class yolo_detect():
    ...
    def yolo_model_and_thub_send(self):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
            ...
            while True:
                ...
                self.folder_path = f"C:/Users/abc/Desktop/신종감염병/yolov5/files/hyo/{self.deviceid}/{date}"
    ...
    def multi_processing_flask_and_mask(self):
        ...
        Processes1 = self.mp.Process(target=self.yolo_model_and_thub_send(), name='flask_get_1') #self.future2
